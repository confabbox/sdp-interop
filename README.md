[![Build Status](https://travis-ci.org/confabbox/sdp-interop.svg?branch=master)](https://travis-ci.org/confabbox/sdp-interop)
...
endpoints, so all the media whatever the channel is, go through a single port. This is tracked in [issue #3](https://github.com/confabbox/sdp-interop/issues/3).
